...
public class ClasseCorridas {
    ...
    private double tempoCompetidor2; //o tempo vai ser contabilizado em segundos

    public ClasseCorridas(String competidor1, String competidor2){
        this.competidor1 = competidor1;
        this.competidor2 = competidor2;
        this.tempoCompetidor1 = 0.0;
        this.tempoCompetidor2 = 0.0;
    }
    public void registrarTempoCompetidor(double tempo){
    ...
    public String resultado() {
        if (tempoCompetidor1 == 0 || tempoCompetidor2 == 00) {
            return "a corrida ainda nao terminou";
        }
